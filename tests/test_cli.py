...
def test_cli_check_accepts_json_string(mocker):
    ...
    try:
        ...
        mock_validate = mocker.patch('httomo.cli.validate_yaml_config', return_value=True)
        ...
        result = runner.invoke(
            main, 
            ["check", json_string, temp_data_file]
        )
        ...
        assert result.exit_code in [0, 1], f"CLI command failed unexpectedly with: {result.output}"
