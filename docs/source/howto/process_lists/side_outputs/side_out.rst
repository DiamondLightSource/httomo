...
reconstruction method :code:`FBP3d_tomobar` then refers to the found :ref:`centering` for the
...
1. :code:`find_center_360` produces side outputs called :code:`overlap` and :code:`side` that the
   :code:`sino_360_to_180` method uses.
2. :code:`find_center_360` also produces a side output called
   :code:`centre_of_rotation` that the :code:`FBP3d_tomobar` method uses.
