...
class RotationWrapper(GenericMethodWrapper):
    ...
    - calls the center-finding algorithm on the data slice
    ...
    def _process_return_type(self, ret: Any, input_block: T) -> T:
        if type(ret) == tuple:
            ...
            cor_str = f"    ---> The center of rotation, overlap, side and overlap position are {ret}"
            ...
            cor_str = f"    ---> The center of rotation is {ret}"
