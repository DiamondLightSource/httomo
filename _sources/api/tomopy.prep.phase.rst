...
.. dropdown:: retrieve_phase.yaml
    ...
    |link_icon| `Link to retrieve_phase function description <https://tomopy.readthedocs.io/en/v1.14.0/api/tomopy.prep.phase.html#tomopy.prep.phase.retrieve_phase>`_
