...
.. dropdown:: normalize_bg.yaml
    ...
    |link_icon| `Link to normalize_bg function description <https://tomopy.readthedocs.io/en/v1.14.0/api/tomopy.prep.normalize.html#tomopy.prep.normalize.normalize_bg>`_
...
.. dropdown:: normalize.yaml
    ...
    |link_icon| `Link to normalize function description <https://tomopy.readthedocs.io/en/v1.14.0/api/tomopy.prep.normalize.html#tomopy.prep.normalize.normalize>`_
...
.. dropdown:: normalize_roi.yaml
    ...
    |link_icon| `Link to normalize_roi function description <https://tomopy.readthedocs.io/en/v1.14.0/api/tomopy.prep.normalize.html#tomopy.prep.normalize.normalize_roi>`_
...
.. dropdown:: normalize_nf.yaml
    ...
    |link_icon| `Link to normalize_nf function description <https://tomopy.readthedocs.io/en/v1.14.0/api/tomopy.prep.normalize.html#tomopy.prep.normalize.normalize_nf>`_
...
.. dropdown:: minus_log.yaml
    ...
    |link_icon| `Link to minus_log function description <https://tomopy.readthedocs.io/en/v1.14.0/api/tomopy.prep.normalize.html#tomopy.prep.normalize.minus_log>`_
